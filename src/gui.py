...
## Kelas     : 01
## File      : gui.py
## Deskripsi : GUI dari Aplikasi Klinik X Kelompok 9
...
def main():
    # Fungsi agar tombol yang dibuat dapat digunakan
    ...
    # fungsi untuk menampilkan output yang menggunakan scrollbar
    ...
    # fungsi untuk menampilkan output yang kecil dengan menggunakan scrollbar
    ...
    # fungsi untuk menampilkan output yang besar dengan menggunakan scrollbar
    ...
    # Fungsi menampilkan pesan yang error
    def show_error_message(message, title):
        messagebox.showerror(title, message)

    # Fungsi menampilkan window baru untuk fitur 1
    ...
    # Fungsi menampilkan window baru untuk fitur 2
    ...
    def tambah_riwayat_pasien():
        ...
        def submit_riwayat():
            ...
            diagnosa = diagnosa_combobox.get()  
            tindakan = tindakan_combobox.get()  
        ...
        if id_pasien:
            ...
            if output:
                if "Riwayat pasien berdasarkan ID yang di input tidak dapat ditemukan." in output:
                    ...
                    # Extract output dengan bantuan regex
                    ...
                    if records:
                        ...
                        if str(record_number) in record_numbers:
                            ...
                            def submit_perubahan():
                                ...
                                diagnosa_baru = diagnosa_combobox.get()  
                                tindakan_baru = tindakan_combobox.get()  
                                kontrol_baru = kontrol_entry.get()

                                if tanggal_baru and diagnosa_baru and tindakan_baru and kontrol_baru:
                                    # Mengambil nilai integer agar input sesuai dengan fungsi yang bersangkutan
